...
set :application, "lantan_official"  #应用名称
...
set :repository,  "git@github.com:lifang/lantan_official.git" #项目在github上的地址
...
#  run "ln -s /opt/projects/public/bam_public/storeimg /opt/projects/public/headoffice_public/storeimg"
  run "ln -s /opt/projects/public/official_public/* #{current_path}/public/"  #link public文件夹到/opt/projects/public/bam_public/
